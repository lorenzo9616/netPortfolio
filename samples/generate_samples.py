...
def hospital_bill():
    ...
    pdf.multi_cell(0, 4,
        "For billing inquiries, please contact our Billing Department at (02) 8-555-0110 "
        "or billing@metrogeneralhospital.ph. Please present this document together with "
...
def payslip():
    ...
    pdf.cell(0, 4,
        "For payroll discrepancies or inquiries, please contact payroll@nexbridgeholdings.com or call (02) 8-888-0200.",
        new_x=XPos.LMARGIN, new_y=YPos.NEXT, align="C")
...
def bank_receipt():
    ...
    pdf.set_text_color(80, 80, 80)
    pdf.multi_cell(0, 5,
        "This is your official transaction receipt. For disputes or inquiries, "
        "please call BDO Customer Care at (02) 8-631-8000 or visit any BDO branch within 15 days.")
    pdf.set_text_color(0, 0, 0)
    pdf.ln(5)
